...
!function(e) {
    ...
    Object.assign(s.prototype, {
        ...
        setHSL: function(e, t, n) {
            if (e = i.a.euclideanModulo(e, 1), t = i.a.clamp(t, 0, 1), n = i.a.clamp(n, 0, 1), 0 === t)
        ...
        offsetHSL: function(e, t, n) {
            return this.getHSL(a), a.h += e, a.s += t, a.l += n, this.setHSL(a.h, a.s, a.l), this
        },
        add: function(e) {
            return this.r += e.r, this.g += e.g, this.b += e.b, this
        },
    ...
    Object.assign(r.prototype, {
        ...
        multiplyMatrices: function(e, t) {
            var n = e.elements,
                ...
                M = i[5],
                b = i[8];
            return r[0] = a * p + o * v + s * y, r[3] = a * m + o * _ + s * M, r[6] = a * g + o * x + s * b, r[1] = l * p + c * v + u * y, r[4] = l * m + c * _ + u * M, r[7] = l * g + c * x + u * b, r[2] = h * p + d * v + f * y, r[5] = h * m + d * _ + f * M, r[8] = h * g + d * x + f * b, this
        },
        multiplyScalar: function(e) {
            var t = this.elements;
        ...
        getInverse: function(e, t) {
            ...
            var _ = 1 / g;
            return i[0] = f * _, i[1] = (o * h - d * a) * _, i[2] = (c * a - o * l) * _, i[3] = p * _, i[4] = (d * r - o * u) * _, i[5] = (o * s - c * r) * _, i[6] = m * _, i[7] = (a * u - h * r) * _, i[8] = (l * r - a * s) * _, this
        },
        transpose: function() {
            var e,
                t = this.elements;
    ...
    Object.assign(r, {
        ...
        slerpFlat: function(e, t, n, i, r, a, o) {
            ...
            if (u !== p || s !== h || l !== d || c !== f) {
                ...
                var M = o * v;
                if (s = s * m + h * M, l = l * m + d * M, c = c * m + f * M, u = u * m + p * M, m === 1 - o) {
    ...
    Object.assign(r.prototype, {
        ...
        setFromEuler: function(e, t) {
            ...
            var n = e._x,
                ...
                d = s(i / 2),
                f = s(r / 2);
            return "XYZ" === a ? (this._x = h * c * u + l * d * f, this._y = l * d * u - h * c * f, this._z = l * c * f + h * d * u, this._w = l * c * u - h * d * f) : "YXZ" === a ? (this._x = h * c * u + l * d * f, this._y = l * d * u - h * c * f, this._z = l * c * f - h * d * u, this._w = l * c * u + h * d * f) : "ZXY" === a ? (this._x = h * c * u - l * d * f, this._y = l * d * u + h * c * f, this._z = l * c * f + h * d * u, this._w = l * c * u - h * d * f) : "ZYX" === a ? (this._x = h * c * u - l * d * f, this._y = l * d * u + h * c * f, this._z = l * c * f - h * d * u, this._w = l * c * u + h * d * f) : "YZX" === a ? (this._x = h * c * u + l * d * f, this._y = l * d * u + h * c * f, this._z = l * c * f - h * d * u, this._w = l * c * u - h * d * f) : "XZY" === a && (this._x = h * c * u - l * d * f, this._y = l * d * u - h * c * f, this._z = l * c * f + h * d * u, this._w = l * c * u + h * d * f), !1 !== t && this._onChangeCallback(), this
        },
        ...
        setFromRotationMatrix: function(e) {
            var t,
                ...
                h = n[10],
                d = i + s + h;
            return d > 0 ? (t = .5 / Math.sqrt(d + 1), this._w = .25 / t, this._x = (u - l) * t, this._y = (a - c) * t, this._z = (o - r) * t) : i > s && i > h ? (t = 2 * Math.sqrt(1 + i - s - h), this._w = (u - l) / t, this._x = .25 * t, this._y = (r + o) / t, this._z = (a + c) / t) : s > h ? (t = 2 * Math.sqrt(1 + s - i - h), this._w = (a - c) / t, this._x = (r + o) / t, this._y = .25 * t, this._z = (l + u) / t) : (t = 2 * Math.sqrt(1 + h - i - s), this._w = (o - r) / t, this._x = (a + c) / t, this._y = (l + u) / t, this._z = .25 * t), this._onChangeCallback(), this
        },
    ...
    u.prototype = Object.assign(Object.create(r.prototype), {
        ...
        toJSON: function(e) {
            ...
            if (void 0 !== this.image) {
                var r = this.image;
                if (void 0 === r.uuid && (r.uuid = i.a.generateUUID()), !t && void 0 === e.images[r.uuid]) {
                    var a;
                    if (Array.isArray(r)) {
                        a = [];
    ...
    Object.assign(S.prototype, {
        ...
        getCenter: function(e) {
            return void 0 === e && (console.warn("THREE.Box3: .getCenter() target is now required"), e = new d.a), this.isEmpty() ? e.set(0, 0, 0) : e.addVectors(this.min, this.max).multiplyScalar(.5)
        },
        getSize: function(e) {
            return void 0 === e && (console.warn("THREE.Box3: .getSize() target is now required"), e = new d.a), this.isEmpty() ? e.set(0, 0, 0) : e.subVectors(this.max, this.min)
        },
        ...
        expandByObject: function(e) {
            ...
            var t = e.geometry;
            void 0 !== t && (null === t.boundingBox && t.computeBoundingBox(), m.copy(t.boundingBox), m.applyMatrix4(e.matrixWorld), this.expandByPoint(m.min), this.expandByPoint(m.max));
        ...
        getParameter: function(e, t) {
            return void 0 === t && (console.warn("THREE.Box3: .getParameter() target is now required"), t = new d.a), t.set((e.x - this.min.x) / (this.max.x - this.min.x), (e.y - this.min.y) / (this.max.y - this.min.y), (e.z - this.min.z) / (this.max.z - this.min.z))
        },
        intersectsBox: function(e) {
            return !(e.max.x < this.min.x || e.min.x > this.max.x || e.max.y < this.min.y || e.min.y > this.max.y || e.max.z < this.min.z || e.min.z > this.max.z)
        },
        intersectsSphere: function(e) {
            return this.clampPoint(e.center, p), p.distanceToSquared(e.center) <= e.radius * e.radius
        },
        ...
        intersectsTriangle: function(e) {
            ...
            return !!A(t, g, v, _, w) && (!!A(t = [1, 0, 0, 0, 1, 0, 0, 0, 1], g, v, _, w) && (E.crossVectors(x, y), A(t = [E.x, E.y, E.z], g, v, _, w)))
        },
        clampPoint: function(e, t) {
            return void 0 === t && (console.warn("THREE.Box3: .clampPoint() target is now required"), t = new d.a), t.copy(e).clamp(this.min, this.max)
        },
        distanceToPoint: function(e) {
            return p.copy(e).clamp(this.min, this.max).sub(e).length()
        },
        getBoundingSphere: function(e) {
            return void 0 === e && console.error("THREE.Box3: .getBoundingSphere() target is now required"), this.getCenter(e.center), e.radius = .5 * this.getSize(p).length(), e
        },
        ...
        applyMatrix4: function(e) {
            return this.isEmpty() || (f[0].set(this.min.x, this.min.y, this.min.z).applyMatrix4(e), f[1].set(this.min.x, this.min.y, this.max.z).applyMatrix4(e), f[2].set(this.min.x, this.max.y, this.min.z).applyMatrix4(e), f[3].set(this.min.x, this.max.y, this.max.z).applyMatrix4(e), f[4].set(this.max.x, this.min.y, this.min.z).applyMatrix4(e), f[5].set(this.max.x, this.min.y, this.max.z).applyMatrix4(e), f[6].set(this.max.x, this.max.y, this.min.z).applyMatrix4(e), f[7].set(this.max.x, this.max.y, this.max.z).applyMatrix4(e), this.setFromPoints(f)), this
        },
    ...
    Object.assign(R.prototype, {
        ...
        clampPoint: function(e, t) {
            ...
            return void 0 === t && (console.warn("THREE.Sphere: .clampPoint() target is now required"), t = new d.a), t.copy(e), n > this.radius * this.radius && (t.sub(this.center).normalize(), t.multiplyScalar(this.radius).add(this.center)), t
        },
        getBoundingBox: function(e) {
            return void 0 === e && (console.warn("THREE.Sphere: .getBoundingBox() target is now required"), e = new S), e.set(this.center, this.center), e.expandByScalar(this.radius), e
        },
        applyMatrix4: function(e) {
    ...
    Object.assign(C.prototype, {
        ...
        projectPoint: function(e, t) {
            return void 0 === t && (console.warn("THREE.Plane: .projectPoint() target is now required"), t = new d.a), t.copy(this.normal).multiplyScalar(-this.distanceToPoint(e)).add(e)
        },
        intersectLine: function(e, t) {
            void 0 === t && (console.warn("THREE.Plane: .intersectLine() target is now required"), t = new d.a);
            var n = e.delta(P),
                i = this.normal.dot(n);
            if (0 === i)
        ...
        coplanarPoint: function(e) {
            return void 0 === e && (console.warn("THREE.Plane: .coplanarPoint() target is now required"), e = new d.a), e.copy(this.normal).multiplyScalar(-this.constant)
        },
    ...
    Object.assign(F.prototype, {
        ...
        setFromMatrix: function(e) {
            var t = this.planes,
                ...
                v = n[14],
                _ = n[15];
            return t[0].setComponents(o - i, u - s, p - h, _ - m).normalize(), t[1].setComponents(o + i, u + s, p + h, _ + m).normalize(), t[2].setComponents(o + r, u + l, p + d, _ + g).normalize(), t[3].setComponents(o - r, u - l, p - d, _ - g).normalize(), t[4].setComponents(o - a, u - c, p - f, _ - v).normalize(), t[5].setComponents(o + a, u + c, p + f, _ + v).normalize(), this
        },
        intersectsObject: function(e) {
            var t = e.geometry;
            return null === t.boundingSphere && t.computeBoundingSphere(), I.copy(t.boundingSphere).applyMatrix4(e.matrixWorld), this.intersectsSphere(I)
        },
        intersectsSprite: function(e) {
            return I.center.set(0, 0, 0), I.radius = .7071067811865476, I.applyMatrix4(e.matrixWorld), this.intersectsSphere(I)
        },
        intersectsSphere: function(e) {
        ...
        intersectsBox: function(e) {
            for (var t = this.planes, n = 0; n < 6; n++) {
                var i = t[n];
                if (U.x = i.normal.x > 0 ? e.max.x : e.min.x, U.y = i.normal.y > 0 ? e.max.y : e.min.y, U.z = i.normal.z > 0 ? e.max.z : e.min.z, i.distanceToPoint(U) < 0)
                    return !1
            }
            return !0
        },
    ...
    Object.assign(W.prototype, {
        ...
        set: function(e, t, n, i, r, a, o, s, l, c, u, h, d, f, p, m) {
            var g = this.elements;
            return g[0] = e, g[4] = t, g[8] = n, g[12] = i, g[1] = r, g[5] = a, g[9] = o, g[13] = s, g[2] = l, g[6] = c, g[10] = u, g[14] = h, g[3] = d, g[7] = f, g[11] = p, g[15] = m, this
        },
        identity: function() {
        ...
        lookAt: function(e, t, n) {
            var i = this.elements;
            return k.subVectors(e, t), 0 === k.lengthSq() && (k.z = 1), k.normalize(), V.crossVectors(n, k), 0 === V.lengthSq() && (1 === Math.abs(n.z) ? k.x += 1e-4 : k.z += 1e-4, k.normalize(), V.crossVectors(n, k)), V.normalize(), H.crossVectors(k, V), i[0] = V.x, i[4] = H.x, i[8] = k.x, i[1] = V.y, i[5] = H.y, i[9] = k.y, i[2] = V.z, i[6] = H.z, i[10] = k.z, this
        },
        multiply: function(e, t) {
        ...
        multiplyMatrices: function(e, t) {
            var n = e.elements,
                ...
                U = i[11],
                F = i[15];
            return r[0] = a * M + o * T + s * R + l * C, r[4] = a * b + o * S + s * P + l * I, r[8] = a * w + o * A + s * N + l * U, r[12] = a * E + o * L + s * D + l * F, r[1] = c * M + u * T + h * R + d * C, r[5] = c * b + u * S + h * P + d * I, r[9] = c * w + u * A + h * N + d * U, r[13] = c * E + u * L + h * D + d * F, r[2] = f * M + p * T + m * R + g * C, r[6] = f * b + p * S + m * P + g * I, r[10] = f * w + p * A + m * N + g * U, r[14] = f * E + p * L + m * D + g * F, r[3] = v * M + _ * T + x * R + y * C, r[7] = v * b + _ * S + x * P + y * I, r[11] = v * w + _ * A + x * N + y * U, r[15] = v * E + _ * L + x * D + y * F, this
        },
        multiplyScalar: function(e) {
            var t = this.elements;
        ...
        getInverse: function(e, t) {
            ...
            var S = 1 / E;
            return n[0] = y * S, n[1] = (v * p * s - f * _ * s - v * o * m + a * _ * m + f * o * x - a * p * x) * S, n[2] = (c * _ * s - v * u * s + v * o * h - a * _ * h - c * o * x + a * u * x) * S, n[3] = (f * u * s - c * p * s - f * o * h + a * p * h + c * o * m - a * u * m) * S, n[4] = M * S, n[5] = (d * _ * s - g * p * s + g * o * m - r * _ * m - d * o * x + r * p * x) * S, n[6] = (g * u * s - l * _ * s - g * o * h + r * _ * h + l * o * x - r * u * x) * S, n[7] = (l * p * s - d * u * s + d * o * h - r * p * h - l * o * m + r * u * m) * S, n[8] = b * S, n[9] = (g * f * s - d * v * s - g * a * m + r * v * m + d * a * x - r * f * x) * S, n[10] = (l * v * s - g * c * s + g * a * h - r * v * h - l * a * x + r * c * x) * S, n[11] = (d * c * s - l * f * s - d * a * h + r * f * h + l * a * m - r * c * m) * S, n[12] = w * S, n[13] = (d * v * o - g * f * o + g * a * p - r * v * p - d * a * _ + r * f * _) * S, n[14] = (g * c * o - l * v * o - g * a * u + r * v * u + l * a * _ - r * c * _) * S, n[15] = (l * f * o - d * c * o + d * a * u - r * f * u - l * a * p + r * c * p) * S, this
        },
        scale: function(e) {
            var t = this.elements,
                n = e.x,
        ...
        compose: function(e, t, n) {
            var i = this.elements,
                ...
                M = n.y,
                b = n.z;
            return i[0] = (1 - (p + g)) * y, i[1] = (d + x) * y, i[2] = (f - _) * y, i[3] = 0, i[4] = (d - x) * M, i[5] = (1 - (h + g)) * M, i[6] = (m + v) * M, i[7] = 0, i[8] = (f + _) * b, i[9] = (m - v) * b, i[10] = (1 - (h + p)) * b, i[11] = 0, i[12] = e.x, i[13] = e.y, i[14] = e.z, i[15] = 1, this
        },
        decompose: function(e, t, n) {
            ...
            var s = 1 / r,
                l = 1 / a,
                c = 1 / o;
            return z.elements[0] *= s, z.elements[1] *= s, z.elements[2] *= s, z.elements[4] *= l, z.elements[5] *= l, z.elements[6] *= l, z.elements[8] *= c, z.elements[9] *= c, z.elements[10] *= c, t.setFromRotationMatrix(z), n.x = r, n.y = a, n.z = o, this
        },
    ...
    Object.assign(J.prototype, {
        ...
        setAxisAngleFromRotationMatrix: function(e) {
            ...
            return Math.abs(M) < .001 && (M = 1), this.x = (f - h) / M, this.y = (l - d) / M, this.z = (c - s) / M, this.w = Math.acos((o + u + p - 1) / 2), this
        },
        min: function(e) {
    ...
    Object.assign(ee.prototype, {
        ...
        setFromRotationMatrix: function(e, t, n) {
            var r = i.a.clamp,
                ...
                f = a[6],
                p = a[10];
            return "XYZ" === (t = t || this._order) ? (this._y = Math.asin(r(l, -1, 1)), Math.abs(l) < .9999999 ? (this._x = Math.atan2(-h, p), this._z = Math.atan2(-s, o)) : (this._x = Math.atan2(f, u), this._z = 0)) : "YXZ" === t ? (this._x = Math.asin(-r(h, -1, 1)), Math.abs(h) < .9999999 ? (this._y = Math.atan2(l, p), this._z = Math.atan2(c, u)) : (this._y = Math.atan2(-d, o), this._z = 0)) : "ZXY" === t ? (this._x = Math.asin(r(f, -1, 1)), Math.abs(f) < .9999999 ? (this._y = Math.atan2(-d, p), this._z = Math.atan2(-s, u)) : (this._y = 0, this._z = Math.atan2(c, o))) : "ZYX" === t ? (this._y = Math.asin(-r(d, -1, 1)), Math.abs(d) < .9999999 ? (this._x = Math.atan2(f, p), this._z = Math.atan2(c, o)) : (this._x = 0, this._z = Math.atan2(-s, u))) : "YZX" === t ? (this._z = Math.asin(r(c, -1, 1)), Math.abs(c) < .9999999 ? (this._x = Math.atan2(-h, u), this._y = Math.atan2(-d, o)) : (this._x = 0, this._y = Math.atan2(l, p))) : "XZY" === t ? (this._z = Math.asin(-r(s, -1, 1)), Math.abs(s) < .9999999 ? (this._x = Math.atan2(f, u), this._y = Math.atan2(l, o)) : (this._x = Math.atan2(-h, p), this._y = 0)) : console.warn("THREE.Euler: .setFromRotationMatrix() given unsupported order: " + t), this._order = t, !1 !== n && this._onChangeCallback(), this
        },
        setFromQuaternion: function(e, t, n) {
            return K.makeRotationFromQuaternion(e), this.setFromRotationMatrix(K, t, n)
        },
            ...
            update: function(n, i) {
                ...
                void 0 === r ? t.set(n, function(t, n) {
                    ...
                    var r = n.array,
                        a = n.updateRange;
                    e.bindBuffer(i, t),
                    -1 === a.count ? e.bufferSubData(i, 0, r) : (e.bufferSubData(i, a.offset * r.BYTES_PER_ELEMENT, r.subarray(a.offset, a.offset + a.count)), a.count = -1)
    ...
    me.prototype = Object.assign(Object.create(r.prototype), {
        ...
        rotateOnWorldAxis: function(e, t) {
            return re.setFromAxisAngle(e, t), this.quaternion.premultiply(re), this
        },
        rotateX: function(e) {
        ...
        lookAt: function(e, t, n) {
            ...
            i && (ae.extractRotation(i.matrixWorld), re.setFromRotationMatrix(ae), this.quaternion.premultiply(re.inverse()))
        },
        add: function(e) {
        ...
        remove: function(e) {
            ...
            return -1 !== n && (e.parent = null, this.children.splice(n, 1), e.dispatchEvent(pe)), this
        },
        attach: function(e) {
            return this.updateWorldMatrix(!0, !1), ae.getInverse(this.matrixWorld), null !== e.parent && (e.parent.updateWorldMatrix(!0, !1), ae.multiply(e.parent.matrixWorld)), e.applyMatrix(ae), e.updateWorldMatrix(!1, !1), this.add(e), this
        },
        ...
        getWorldQuaternion: function(e) {
            return void 0 === e && (console.warn("THREE.Object3D: .getWorldQuaternion() target is now required"), e = new Q.a), this.updateMatrixWorld(!0), this.matrixWorld.decompose(se, e, le), e
        },
        getWorldScale: function(e) {
            return void 0 === e && (console.warn("THREE.Object3D: .getWorldScale() target is now required"), e = new d.a), this.updateMatrixWorld(!0), this.matrixWorld.decompose(se, ce, e), e
        },
        getWorldDirection: function(e) {
            void 0 === e && (console.warn("THREE.Object3D: .getWorldDirection() target is now required"), e = new d.a),
    ...
    ge.prototype = Object.assign(Object.create(me.prototype), {
        ...
        isScene: !0,
        copy: function(e, t) {
            return me.prototype.copy.call(this, e, t), null !== e.background && (this.background = e.background.clone()), null !== e.environment && (this.environment = e.environment.clone()), null !== e.fog && (this.fog = e.fog.clone()), null !== e.overrideMaterial && (this.overrideMaterial = e.overrideMaterial.clone()), this.autoUpdate = e.autoUpdate, this.matrixAutoUpdate = e.matrixAutoUpdate, this
        },
        toJSON: function(e) {
    ...
    Ee.prototype = Object.assign(Object.create(r.prototype), {
        ...
        lookAt: function(e) {
            return be.lookAt(e), be.updateMatrix(), this.applyMatrix(be.matrix), this
        },
        ...
        computeVertexNormals: function(e) {
            var t,
                ...
                a,
                o;
            for (void 0 === e && (e = !0), o = new Array(this.vertices.length), t = 0, n = this.vertices.length; t < n; t++)
                o[t] = new d.a;
            if (e) {
                var s,
                    l,
        ...
        computeMorphNormals: function() {
            ...
            for (a.faces = this.faces, e = 0, t = this.morphTargets.length; e < t; e++) {
                ...
                for (a.vertices = this.morphTargets[e].vertices, a.computeFaceNormals(), a.computeVertexNormals(), n = 0, i = this.faces.length; n < i; n++)
                    r = this.faces[n],
                    l = u.faceNormals[n],
                    c = u.vertexNormals[n],
                    l.copy(r.normal),
        ...
        mergeVertices: function() {
            ...
            for (n = 0, i = this.vertices.length; n < i; n++)
                e = this.vertices[n],
                void 0 === l[t = Math.round(e.x * h) + "_" + Math.round(e.y * h) + "_" + Math.round(e.z * h)] ? (l[t] = n, c.push(this.vertices[n]), u[n] = c.length - 1) : u[n] = u[l[t]];
            var d = [];
            for (n = 0, i = this.faces.length; n < i; n++) {
            ...
            for (n = d.length - 1; n >= 0; n--) {
                var p = d[n];
                for (this.faces.splice(p, 1), o = 0, s = this.faceVertexUvs.length; o < s; o++)
        ...
        toJSON: function() {
            ...
            for (r = 0; r < this.faces.length; r++) {
                var f = this.faces[r],
                    ...
                    x = 0;
                if (x = w(x, 0, 0), x = w(x, 1, !0), x = w(x, 2, !1), x = w(x, 3, p), x = w(x, 4, m), x = w(x, 5, g), x = w(x, 6, v), x = w(x, 7, _), o.push(x), o.push(f.a, f.b, f.c), o.push(f.materialIndex), p) {
            ...
            return e.data = {}, e.data.vertices = i, e.data.normals = s, c.length > 0 && (e.data.colors = c), h.length > 0 && (e.data.uvs = [h]), e.data.faces = o, e
        },
        clone: function() {
        ...
        copy: function(e) {
            ...
            for (t = 0, n = g.length; t < n; t++) {
                ...
                if (void 0 !== g[t].faceNormals)
                    for (v.faceNormals = [], i = 0, r = g[t].faceNormals.length; i < r; i++)
    ...
    Object.assign(Se.prototype, {
        ...
        copyColorsArray: function(e) {
            for (var t = this.array, n = 0, i = 0, r = e.length; i < r; i++) {
                var a = e[i];
                void 0 === a && (console.warn("THREE.BufferAttribute.copyColorsArray(): color is undefined", i), a = new Y.a),
                t[n++] = a.r,
                t[n++] = a.g,
                t[n++] = a.b
            }
        ...
        copyVector2sArray: function(e) {
            for (var t = this.array, n = 0, i = 0, r = e.length; i < r; i++) {
                var a = e[i];
                void 0 === a && (console.warn("THREE.BufferAttribute.copyVector2sArray(): vector is undefined", i), a = new o.a),
                t[n++] = a.x,
                t[n++] = a.y
            }
            return this
        ...
        copyVector3sArray: function(e) {
            for (var t = this.array, n = 0, i = 0, r = e.length; i < r; i++) {
                var a = e[i];
                void 0 === a && (console.warn("THREE.BufferAttribute.copyVector3sArray(): vector is undefined", i), a = new d.a),
                t[n++] = a.x,
                t[n++] = a.y,
                t[n++] = a.z
            }
        ...
        copyVector4sArray: function(e) {
            for (var t = this.array, n = 0, i = 0, r = e.length; i < r; i++) {
                var a = e[i];
                void 0 === a && (console.warn("THREE.BufferAttribute.copyVector4sArray(): vector is undefined", i), a = new J),
                t[n++] = a.x,
                t[n++] = a.y,
                t[n++] = a.z,
                t[n++] = a.w
    ...
    Object.assign(Fe.prototype, {
        ...
        fromGeometry: function(e) {
            ...
            for (u = 0; u < n.length; u++) {
                ...
                if (!0 === a)
                    void 0 !== (M = r[0][u]) ? this.uvs.push(M[0], M[1], M[2]) : (console.warn("THREE.DirectGeometry.fromGeometry(): Undefined vertexUv ", u), this.uvs.push(new o.a, new o.a, new o.a));
                if (!0 === s)
                    void 0 !== (M = r[1][u]) ? this.uvs2.push(M[0], M[1], M[2]) : (console.warn("THREE.DirectGeometry.fromGeometry(): Undefined vertexUv2 ", u), this.uvs2.push(new o.a, new o.a, new o.a));
                for (var E = 0; E < c; E++) {
                    var T = l[E].vertices;
    ...
    je.prototype = Object.assign(Object.create(r.prototype), {
        ...
        lookAt: function(e) {
            return Ge.lookAt(e), Ge.updateMatrix(), this.applyMatrix(Ge.matrix), this
        },
        center: function() {
        ...
        updateFromObject: function(e) {
            ...
            if (e.isMesh) {
                ...
                if (!0 === n.elementsNeedUpdate && (i = void 0, n.elementsNeedUpdate = !1), void 0 === i)
        ...
        fromGeometry: function(e) {
            return e.__directGeometry = (new Fe).fromGeometry(e), this.fromDirectGeometry(e.__directGeometry)
        },
        fromDirectGeometry: function(e) {
            var t = new Float32Array(3 * e.vertices.length);
            if (this.setAttribute("position", new Se(t, 3).copyVector3sArray(e.vertices)), e.normals.length > 0) {
            ...
            if (void 0 !== e) {
                if (this.boundingBox.setFromBufferAttribute(e), t)
                    for (var n = 0, i = t.length; n < i; n++) {
                        ...
                        this.morphTargetsRelative ? (We.addVectors(this.boundingBox.min, He.min), this.boundingBox.expandByPoint(We), We.addVectors(this.boundingBox.max, He.max), this.boundingBox.expandByPoint(We)) : (this.boundingBox.expandByPoint(He.min), this.boundingBox.expandByPoint(He.max))
                    }
            } else
            ...
            if (e) {
                ...
                if (He.setFromBufferAttribute(e), t)
                    for (var i = 0, r = t.length; i < r; i++) {
                        ...
                        this.morphTargetsRelative ? (We.addVectors(He.min, ke.min), He.expandByPoint(We), We.addVectors(He.max, ke.max), He.expandByPoint(We)) : (He.expandByPoint(ke.min), He.expandByPoint(ke.max))
                    }
                He.getCenter(n);
                var o = 0;
            ...
            if (e && e.isBufferGeometry) {
                ...
                for (var i in n)
                    if (void 0 !== e.attributes[i])
                        for (var r = n[i].array, a = e.attributes[i], o = a.array, s = a.itemSize * t, l = Math.min(o.length, r.length - s), c = 0, u = s; c < l; c++, u++)
                            r[u] = o[c];
                return this
            }
    ...
    Qe.prototype.copy = function(e) {
        return Je.prototype.copy.call(this, e), this.fragmentShader = e.fragmentShader, this.vertexShader = e.vertexShader, this.uniforms = Object(X.b)(e.uniforms), this.defines = Object.assign({}, e.defines), this.wireframe = e.wireframe, this.wireframeLinewidth = e.wireframeLinewidth, this.lights = e.lights, this.clipping = e.clipping, this.skinning = e.skinning, this.morphTargets = e.morphTargets, this.morphNormals = e.morphNormals, this.extensions = e.extensions, this
    },
    ...
    Object.assign(at.prototype, {
        ...
        at: function(e, t) {
            return void 0 === t && (console.warn("THREE.Ray: .at() target is now required"), t = new d.a), t.copy(this.direction).multiplyScalar(e).add(this.origin)
        },
        lookAt: function(e) {
        ...
        closestPointToPoint: function(e, t) {
            void 0 === t && (console.warn("THREE.Ray: .closestPointToPoint() target is now required"), t = new d.a),
        ...
        distanceSqToPoint: function(e) {
            ...
            return t < 0 ? this.origin.distanceToSquared(e) : (Ke.copy(this.direction).multiplyScalar(t).add(this.origin), Ke.distanceToSquared(e))
        },
        distanceSqToSegment: function(e, t, n, i) {
            ...
            if (f > 0)
                ...
                a = c > 0 ? -l : l,
                o = -(r = Math.max(0, -(c * a + u))) * r + a * (a + 2 * h) + d;
            return n && n.copy(this.direction).multiplyScalar(r).add(this.origin), i && i.copy(et).multiplyScalar(a).add($e), o
        },
    ...
    Object.assign(gt, {
        getNormal: function(e, t, n, i) {
            void 0 === i && (console.warn("THREE.Triangle: .getNormal() target is now required"), i = new d.a),
            i.subVectors(n, t),
            ot.subVectors(e, t),
            i.cross(ot);
            var r = i.lengthSq();
        ...
        getBarycoord: function(e, t, n, i, r) {
            ...
            var a = ot.dot(ot),
                ...
                c = st.dot(lt),
                u = a * l - o * o;
            if (void 0 === r && (console.warn("THREE.Triangle: .getBarycoord() target is now required"), r = new d.a), 0 === u)
                return r.set(-2, -1, -1);
            var h = 1 / u,
                f = (l * s - o * c) * h,
                p = (a * c - o * s) * h;
        ...
        containsPoint: function(e, t, n, i) {
            return gt.getBarycoord(e, t, n, i, ct), ct.x >= 0 && ct.y >= 0 && ct.x + ct.y <= 1
        },
        getUV: function(e, t, n, i, r, a, o, s) {
            return this.getBarycoord(e, t, n, i, ct), s.set(0, 0), s.addScaledVector(r, ct.x), s.addScaledVector(a, ct.y), s.addScaledVector(o, ct.z), s
        },
        isFrontFacing: function(e, t, n, i) {
            return ot.subVectors(n, t), st.subVectors(e, t), ot.cross(st).dot(i) < 0
        }
    }),
    Object.assign(gt.prototype, {
        ...
        getArea: function() {
            return ot.subVectors(this.c, this.b), st.subVectors(this.a, this.b), .5 * ot.cross(st).length()
        },
        getMidpoint: function(e) {
            return void 0 === e && (console.warn("THREE.Triangle: .getMidpoint() target is now required"), e = new d.a), e.addVectors(this.a, this.b).add(this.c).multiplyScalar(1 / 3)
        },
        getNormal: function(e) {
            return gt.getNormal(this.a, this.b, this.c, e)
        },
        getPlane: function(e) {
            return void 0 === e && (console.warn("THREE.Triangle: .getPlane() target is now required"), e = new C), e.setFromCoplanarPoints(this.a, this.b, this.c)
        },
        ...
        closestPointToPoint: function(e, t) {
            void 0 === t && (console.warn("THREE.Triangle: .closestPointToPoint() target is now required"), t = new d.a);
            var n,
                i,
                r = this.a,
                a = this.b,
            ...
            var g = c * p - f * u;
            if (g <= 0 && u - c >= 0 && f - p >= 0)
                return dt.subVectors(o, a), i = (u - c) / (u - c + (f - p)), t.copy(a).addScaledVector(dt, i);
            var v = 1 / (g + m + h);
            return n = m * v, i = h * v, t.copy(r).addScaledVector(ut, n).addScaledVector(ht, i)
        },
        equals: function(e) {
    ...
    function Ot(e, t, n, i, r, a, s, l, c, u, h, d) {
        ...
        if (t.morphTargets && a && f) {
            ...
            for (var p = 0, m = a.length; p < m; p++) {
                var g = f[p],
                    v = a[p];
                0 !== g && (Et.fromBufferAttribute(v, u), Tt.fromBufferAttribute(v, h), St.fromBufferAttribute(v, d), s ? (At.addScaledVector(Et, g), Lt.addScaledVector(Tt, g), Rt.addScaledVector(St, g)) : (At.addScaledVector(Et.sub(Mt), g), Lt.addScaledVector(Tt.sub(bt), g), Rt.addScaledVector(St.sub(wt), g)))
            }
            Mt.add(At),
            bt.add(Lt),
            wt.add(Rt)
        ...
        if (_) {
            l && (Pt.fromBufferAttribute(l, u), Nt.fromBufferAttribute(l, h), Dt.fromBufferAttribute(l, d), _.uv = gt.getUV(Ct, Mt, bt, wt, Pt, Nt, Dt, new o.a)),
            c && (Pt.fromBufferAttribute(c, u), Nt.fromBufferAttribute(c, h), Dt.fromBufferAttribute(c, d), _.uv2 = gt.getUV(Ct, Mt, bt, wt, Pt, Nt, Dt, new o.a));
            var x = new xe(u, h, d);
    ...
    function zt(e, t, n, i) {
        ...
        return {
            ...
            render: function(t, i, h, d) {
                ...
                if (m && "additive" === m.environmentBlendMode && (f = null), null === f ? (u(o, s), l = null, c = 0) : f && f.isColor && (u(f, 1), d = !0, l = null, c = 0), (e.autoClear || d) && e.clear(e.autoClearColor, e.autoClearDepth, e.autoClearStencil), f && (f.isCubeTexture || f.isWebGLRenderTargetCube || 306 === f.mapping)) {
                    ...
                    l === f && c === g.version || (a.material.needsUpdate = !0, l = f, c = g.version),
                    ...
                    }), n.update(r)), r.material.uniforms.t2D.value = f, !0 === f.matrixAutoUpdate && f.updateMatrix(), r.material.uniforms.uvTransform.value.copy(f.matrix), l === f && c === f.version || (r.material.needsUpdate = !0, l = f, c = f.version), t.unshift(r, r.geometry, r.material, 0, 0, null))
            }
        }
    }
    function Bt(e, t, n, i) {
    ...
    function qt(e) {
        ...
        return {
            update: function(i, r, a, o) {
                ...
                for (u = 0; u < l; u++) {
                    0 !== (p = c[u])[1] && (h && r.deleteAttribute("morphTarget" + u), d && r.deleteAttribute("morphNormal" + u))
                }
                for (u = 0; u < l; u++) {
                    (p = c[u])[0] = u,
                    p[1] = s[u]
        ...
        return {
            update: function(a) {
                var o = i.render.frame,
                    s = a.geometry,
                    l = t.get(a, s);
                return r[l.id] !== o && (s.isGeometry && l.updateFromObject(a), t.update(l), r[l.id] = o), a.isInstancedMesh && n.update(a.instanceMatrix, e.ARRAY_BUFFER), l
            },
            dispose: function() {
                r = {}
            }
    ...
    Ut.prototype = Object.assign(Object.create(me.prototype), {
        ...
        isMesh: !0,
        copy: function(e) {
            return me.prototype.copy.call(this, e), void 0 !== e.morphTargetInfluences && (this.morphTargetInfluences = e.morphTargetInfluences.slice()), void 0 !== e.morphTargetDictionary && (this.morphTargetDictionary = Object.assign({}, e.morphTargetDictionary)), this
        },
        ...
        raycast: function(e, t) {
            var n,
                ...
                r = this.material,
                a = this.matrixWorld;
            if (void 0 !== r && (null === i.boundingSphere && i.computeBoundingSphere(), yt.copy(i.boundingSphere), yt.applyMatrix4(a), !1 !== e.ray.intersectsSphere(yt) && (_t.getInverse(a), xt.copy(e.ray).applyMatrix4(_t), null === i.boundingBox || !1 !== xt.intersectsBox(i.boundingBox))))
                if (i.isBufferGeometry) {
                    var s,
                        l,
                        c,
                    ...
                    if (null !== g)
                        if (Array.isArray(r))
                            for (u = 0, d = b.length; u < d; u++)
                                for (m = r[(p = b[u]).materialIndex], h = Math.max(p.start, w.start), f = Math.min(p.start + p.count, w.start + w.count); h < f; h += 3)
                                    s = g.getX(h),
                                    l = g.getX(h + 1),
                                    c = g.getX(h + 2),
                                    (n = Ot(this, m, e, xt, v, _, x, y, M, s, l, c)) && (n.faceIndex = Math.floor(h / 3), n.face.materialIndex = p.materialIndex, t.push(n));
                        else
                            for (u = Math.max(0, w.start), d = Math.min(g.count, w.start + w.count); u < d; u += 3)
                                s = g.getX(u),
                                l = g.getX(u + 1),
                                c = g.getX(u + 2),
                                (n = Ot(this, r, e, xt, v, _, x, y, M, s, l, c)) && (n.faceIndex = Math.floor(u / 3), t.push(n));
                    else if (void 0 !== v)
                        if (Array.isArray(r))
                            for (u = 0, d = b.length; u < d; u++)
                                for (m = r[(p = b[u]).materialIndex], h = Math.max(p.start, w.start), f = Math.min(p.start + p.count, w.start + w.count); h < f; h += 3)
                                    (n = Ot(this, m, e, xt, v, _, x, y, M, s = h, l = h + 1, c = h + 2)) && (n.faceIndex = Math.floor(h / 3), n.face.materialIndex = p.materialIndex, t.push(n));
                        else
                            for (u = Math.max(0, w.start), d = Math.min(v.count, w.start + w.count); u < d; u += 3)
                                (n = Ot(this, r, e, xt, v, _, x, y, M, s = u, l = u + 1, c = u + 2)) && (n.faceIndex = Math.floor(u / 3), t.push(n))
                    ...
                    for (var D = 0, C = P.length; D < C; D++) {
                        ...
                        if (void 0 !== U && (E = R[I.a], T = R[I.b], S = R[I.c], n = Ft(this, U, e, xt, E, T, S, Ct))) {
                            if (A && A[D]) {
                                var F = A[D];
                                Pt.copy(F[0]),
                                Nt.copy(F[1]),
    ...
    function ci(e, t, n, i, r, a) {
        ...
        if (h.attachShader(b, P), h.attachShader(b, N), void 0 !== i.index0AttributeName ? h.bindAttribLocation(b, 0, i.index0AttributeName) : !0 === a.morphTargets && h.bindAttribLocation(b, 0, "position"), h.linkProgram(b), e.debug.checkShaderErrors) {
        ...
        return h.deleteShader(P), h.deleteShader(N), this.getUniforms = function() {
            ...
            h.deleteProgram(b),
            this.program = void 0
        }, this.name = r.name, this.id = Yn++, this.cacheKey = n, this.usedTimes = 1, this.program = b, this.vertexShader = P, this.fragmentShader = N, this.numMultiviewViews = w, this
    }
    function ui(e, t, n) {
        var i = [],
            r = n.isWebGL2,
    ...
    function mi() {
        ...
        return {
            get: function(n, i) {
                var r,
                    a = e.get(n);
                return void 0 === a ? (r = new pi, e.set(n, new WeakMap), e.get(n).set(i, r), n.addEventListener("dispose", t)) : void 0 === (r = a.get(i)) && (r = new pi, a.set(i, r)), r
            },
            dispose: function() {
                e = new WeakMap
            }
            ...
            setup: function(n, o, s) {
                ...
                for (var M = n.length; h < M; h++) {
                    ...
                    if (b.isAmbientLight)
                        ...
                        if ((R = e.get(b)).color.copy(b.color).multiplyScalar(b.intensity), R.direction.setFromMatrixPosition(b.matrixWorld), i.setFromMatrixPosition(b.target.matrixWorld), R.direction.sub(i), R.direction.transformDirection(y), R.shadow = b.castShadow, b.castShadow) {
                            var L = b.shadow;
                            R.shadowBias = L.bias,
                        ...
                        if ((R = e.get(b)).position.setFromMatrixPosition(b.matrixWorld), R.position.applyMatrix4(y), R.color.copy(b.color).multiplyScalar(b.intensity), R.distance = b.distance, R.decay = b.decay, R.shadow = b.castShadow, b.castShadow) {
                            L = b.shadow;
                            R.shadowBias = L.bias,
                            R.shadowRadius = L.radius,
                            R.shadowMapSize = L.mapSize,
                ...
                t.ambient[2] = u;
                var P = t.hash;
                P.directionalLength === d && P.pointLength === f && P.spotLength === p && P.rectAreaLength === m && P.hemiLength === g && P.numDirectionalShadows === v && P.numPointShadows === _ && P.numSpotShadows === x || (t.directional.length = d, t.spot.length = p, t.rectArea.length = m, t.point.length = f, t.hemi.length = g, t.directionalShadowMap.length = v, t.pointShadowMap.length = _, t.spotShadowMap.length = x, t.directionalShadowMatrix.length = v, t.pointShadowMatrix.length = _, t.spotShadowMatrix.length = x, P.directionalLength = d, P.pointLength = f, P.spotLength = p, P.rectAreaLength = m, P.hemiLength = g, P.numDirectionalShadows = v, P.numPointShadows = _, P.numSpotShadows = x, t.version = vi++)
            },
            state: t
        }
    }
    ...
    function Mi() {
        ...
        return {
            get: function(n, i) {
                var r;
                return !1 === e.has(n) ? (r = new yi, e.set(n, new WeakMap), e.get(n).set(i, r), n.addEventListener("dispose", t)) : !1 === e.get(n).has(i) ? (r = new yi, e.get(n).set(i, r)) : r = e.get(n).get(i), r
            },
            dispose: function() {
                e = new WeakMap
            }
    ...
    wi.prototype.copy = function(e) {
        return Je.prototype.copy.call(this, e), this.depthPacking = e.depthPacking, this.skinning = e.skinning, this.morphTargets = e.morphTargets, this.map = e.map, this.alphaMap = e.alphaMap, this.displacementMap = e.displacementMap, this.displacementScale = e.displacementScale, this.displacementBias = e.displacementBias, this.wireframe = e.wireframe, this.wireframeLinewidth = e.wireframeLinewidth, this
    },
    Ei.prototype = Object.create(Je.prototype),
    Ei.prototype.constructor = Ei,
    Ei.prototype.isMeshDistanceMaterial = !0,
    Ei.prototype.copy = function(e) {
        return Je.prototype.copy.call(this, e), this.referencePosition.copy(e.referencePosition), this.nearDistance = e.nearDistance, this.farDistance = e.farDistance, this.skinning = e.skinning, this.morphTargets = e.morphTargets, this.map = e.map, this.alphaMap = e.alphaMap, this.displacementMap = e.displacementMap, this.displacementScale = e.displacementScale, this.displacementBias = e.displacementBias, this
    };
    function Ti(e, t, n) {
        var i = new F,
            r = new o.a,
        ...
        function y(t, n, i, r, a, o) {
            ...
            if (!0 === i.isPointLight && (c = x, d = t.customDistanceMaterial), void 0 === d) {
                var f = !1;
            ...
            if (!1 !== g.enabled && (!1 !== g.autoUpdate || !1 !== g.needsUpdate) && 0 !== t.length) {
                ...
                for (var f = 0, p = t.length; f < p; f++) {
                    ...
                    if (void 0 !== _) {
                        ...
                        if (r.multiply(x), a.copy(_.mapSize), (r.x > n || r.y > n) && (console.warn("THREE.WebGLShadowMap:", m, "has shadow exceeding max texture size, reducing"), r.x > n && (a.x = Math.floor(n / x.x), r.x = a.x * x.x, _.mapSize.x = a.x), r.y > n && (a.y = Math.floor(n / x.y), r.y = a.y * x.y, _.mapSize.y = a.y)), null === _.map && !_.isPointLightShadow && 3 === this.type) {
                            var y = {
                                minFilter: 1006,
                                magFilter: 1006,
                                format: 1023
    ...
    function Si(e, t, n) {
        ...
        -1 !== P.indexOf("WebGL") ? (R = parseFloat(/^WebGL\ ([0-9])/.exec(P)[1]), L = R >= 1) : -1 !== P.indexOf("OpenGL ES") && (R = parseFloat(/^OpenGL\ ES\ ([0-9])/.exec(P)[1]), L = R >= 2);
        var N = null,
            D = {},
            C = new J,
            I = new J;
        ...
        function k(t, n, i, r, a, o, s, l) {
            if (0 !== t) {
                if (f || (z(e.BLEND), f = !0), 5 === t)
                    ...
                    o = o || i,
                    s = s || r,
                    n === m && a === _ || (e.blendEquationSeparate(G[n], G[a]), m = n, _ = a),
                    i === g && r === v && o === x && s === y || (e.blendFuncSeparate(H[i], H[r], H[o], H[s]), g = i, v = r, x = o, y = s),
                    p = t,
                    M = null;
                else if (t !== p || l !== M) {
                    if (100 === m && 100 === _ || (e.blendEquation(e.FUNC_ADD), m = 100, _ = 100), l)
                        switch (t) {
                        case 1:
        ...
        function j(t) {
            0 !== t ? (z(e.CULL_FACE), t !== w && (1 === t ? e.cullFace(e.BACK) : 2 === t ? e.cullFace(e.FRONT) : e.cullFace(e.FRONT_AND_BACK))) : B(e.CULL_FACE),
            w = t
        }
        function X(t, n, i) {
            t ? (z(e.POLYGON_OFFSET_FILL), T === n && S === i || (e.polygonOffset(n, i), T = n, S = i)) : B(e.POLYGON_OFFSET_FILL)
        }
        function q(t) {
    ...
    function Ai(e, t, n, r, a, o, s) {
        ...
        function v(e, t, n, r) {
            ...
            if ((e.width > r || e.height > r) && (a = r / Math.max(e.width, e.height)), a < 1 || !0 === t) {
                if ("undefined" != typeof HTMLImageElement && e instanceof HTMLImageElement || "undefined" != typeof HTMLCanvasElement && e instanceof HTMLCanvasElement || "undefined" != typeof ImageBitmap && e instanceof ImageBitmap) {
                    ...
                    void 0 === l && (l = g(s, c));
                    var u = n ? g(s, c) : l;
                    return u.width = s, u.height = c, u.getContext("2d").drawImage(e, 0, 0, s, c), console.warn("THREE.WebGLRenderer: Texture has been resized from (" + e.width + "x" + e.height + ") to (" + s + "x" + c + ")."), u
                }
        ...
        function M(n, i, r) {
            ...
            var a = i;
            return i === e.RED && (r === e.FLOAT && (a = e.R32F), r === e.HALF_FLOAT && (a = e.R16F), r === e.UNSIGNED_BYTE && (a = e.R8)), i === e.RGB && (r === e.FLOAT && (a = e.RGB32F), r === e.HALF_FLOAT && (a = e.RGB16F), r === e.UNSIGNED_BYTE && (a = e.RGB8)), i === e.RGBA && (r === e.FLOAT && (a = e.RGBA32F), r === e.HALF_FLOAT && (a = e.RGBA16F), r === e.UNSIGNED_BYTE && (a = e.RGBA8)), a === e.R16F || a === e.R32F || a === e.RGBA16F || a === e.RGBA32F ? t.get("EXT_color_buffer_float") : a !== e.RGB16F && a !== e.RGB32F || console.warn("THREE.WebGLRenderer: Floating point textures with RGB format not supported. Please use RGBA instead."), a
        }
        function b(t) {
        ...
        function N(n, i, o) {
            o ? (e.texParameteri(n, e.TEXTURE_WRAP_S, R[i.wrapS]), e.texParameteri(n, e.TEXTURE_WRAP_T, R[i.wrapT]), n !== e.TEXTURE_3D && n !== e.TEXTURE_2D_ARRAY || e.texParameteri(n, e.TEXTURE_WRAP_R, R[i.wrapR]), e.texParameteri(n, e.TEXTURE_MAG_FILTER, P[i.magFilter]), e.texParameteri(n, e.TEXTURE_MIN_FILTER, P[i.minFilter])) : (e.texParameteri(n, e.TEXTURE_WRAP_S, e.CLAMP_TO_EDGE), e.texParameteri(n, e.TEXTURE_WRAP_T, e.CLAMP_TO_EDGE), n !== e.TEXTURE_3D && n !== e.TEXTURE_2D_ARRAY || e.texParameteri(n, e.TEXTURE_WRAP_R, e.CLAMP_TO_EDGE), 1001 === i.wrapS && 1001 === i.wrapT || console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.wrapS and Texture.wrapT should be set to THREE.ClampToEdgeWrapping."), e.texParameteri(n, e.TEXTURE_MAG_FILTER, b(i.magFilter)), e.texParameteri(n, e.TEXTURE_MIN_FILTER, b(i.minFilter)), 1003 !== i.minFilter && 1006 !== i.minFilter && console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter should be set to THREE.NearestFilter or THREE.LinearFilter."));
            ...
            if (s) {
                ...
                if (1016 === i.type && null === (c || t.get("OES_texture_half_float_linear")))
                    return;
                (i.anisotropy > 1 || r.get(i).__currentAnisotropy) && (e.texParameterf(n, s.TEXTURE_MAX_ANISOTROPY_EXT, Math.min(i.anisotropy, a.getMaxAnisotropy())), r.get(i).__currentAnisotropy = i.anisotropy)
            }
        }
        function D(t, n) {
            void 0 === t.__webglInit && (t.__webglInit = !0, n.addEventListener("dispose", w), t.__webglTexture = e.createTexture(), s.memory.textures++)
        }
        function C(t, i, r) {
            var a = e.TEXTURE_2D;
            ...
            if (i.isDepthTexture) {
                ...
                1026 === i.format && p === e.DEPTH_COMPONENT && 1012 !== i.type && 1014 !== i.type && (console.warn("THREE.WebGLRenderer: Use UnsignedShortType or UnsignedIntType for DepthFormat DepthTexture."), i.type = 1012, f = o.convert(i.type)),
                1027 === i.format && (p = e.DEPTH_STENCIL, 1020 !== i.type && (console.warn("THREE.WebGLRenderer: Use UnsignedInt248Type for DepthStencilFormat DepthTexture."), i.type = 1020, f = o.convert(i.type))),
        ...
        function F(t) {
            ...
            if (t.depthTexture) {
                ...
                !function(t, n) {
                    ...
                    r.get(n.depthTexture).__webglTexture && n.depthTexture.image.width === n.width && n.depthTexture.image.height === n.height || (n.depthTexture.image.width = n.width, n.depthTexture.image.height = n.height, n.depthTexture.needsUpdate = !0),
                    S(n.depthTexture, 0);
        ...
        this.allocateTextureUnit = function() {
            var e = T;
            return e >= u && console.warn("THREE.WebGLTextures: Trying to use " + e + " texture units while this GPU supports only " + u), T += 1, e
        },
        ...
        this.setTexture2DArray = function(t, i) {
            var a = r.get(t);
            t.version > 0 && a.__version !== t.version ? C(a, t, i) : (n.activeTexture(e.TEXTURE0 + i), n.bindTexture(e.TEXTURE_2D_ARRAY, a.__webglTexture))
        },
        this.setTexture3D = function(t, i) {
            var a = r.get(t);
            t.version > 0 && a.__version !== t.version ? C(a, t, i) : (n.activeTexture(e.TEXTURE0 + i), n.bindTexture(e.TEXTURE_3D, a.__webglTexture))
        },
        ...
        this.setupRenderTarget = function(i) {
            ...
            if (u) {
                ...
                if (c) {
                    ...
                    e.bindRenderbuffer(e.RENDERBUFFER, null),
                    i.depthBuffer && (a.__webglDepthRenderbuffer = e.createRenderbuffer(), U(a.__webglDepthRenderbuffer, i, !0)),
                    e.bindFramebuffer(e.FRAMEBUFFER, null)
                } else
            ...
            if (u) {
                ...
                d || (n.bindTexture(e.TEXTURE_2D, l.__webglTexture), N(e.TEXTURE_2D, i.texture, f), I(a.__webglFramebuffer, i, e.COLOR_ATTACHMENT0, e.TEXTURE_2D), x(i.texture, f) && y(e.TEXTURE_2D, i.texture, i.width, i.height), n.bindTexture(e.TEXTURE_2D, null));
            i.depthBuffer && F(i)
        },
        ...
        this.safeSetTexture2D = function(e, t) {
            e && e.isWebGLRenderTarget && (!1 === z && (console.warn("THREE.WebGLTextures.safeSetTexture2D: don't use render targets as textures. Use their .texture property instead."), z = !0), e = e.texture),
            S(e, t)
        },
        this.safeSetTextureCube = function(e, t) {
            e && e.isWebGLRenderTargetCube && (!1 === B && (console.warn("THREE.WebGLTextures.safeSetTextureCube: don't use cube render targets as textures. Use their .texture property instead."), B = !0), e = e.texture),
    ...
    function Pi(e, t) {
        ...
        this.attachCamera = function(t) {
            !1 !== function(e) {
                ...
                if (i ? c.set(i.width, i.height) : e.getDrawingBufferSize(c), t.isArrayCamera) {
    ...
    function Ui(e, t) {
        ...
        this.getController = function(e) {
            var t = s[e];
            return void 0 === t && ((t = new Ii).matrixAutoUpdate = !1, t.visible = !1, s[e] = t), t
        },
    ...
    Ri.prototype = Object.assign(Object.create(bi.prototype), {
        ...
        copy: function(e) {
            return bi.prototype.copy.call(this, e), this.numViews = e.numViews, this
        },
    ...
    Ni.prototype = Object.assign(Object.create(me.prototype), {
        ...
        isCamera: !0,
        copy: function(e, t) {
            return me.prototype.copy.call(this, e, t), this.matrixWorldInverse.copy(e.matrixWorldInverse), this.projectionMatrix.copy(e.projectionMatrix), this.projectionMatrixInverse.copy(e.projectionMatrixInverse), this
        },
        getWorldDirection: function(e) {
            void 0 === e && (console.warn("THREE.Camera: .getWorldDirection() target is now required"), e = new d.a),
            this.updateMatrixWorld(!0);
            var t = this.matrixWorld.elements;
            return e.set(-t[8], -t[9], -t[10]).normalize()
        },
    ...
    Di.prototype = Object.assign(Object.create(Ni.prototype), {
        ...
        copy: function(e, t) {
            return Ni.prototype.copy.call(this, e, t), this.fov = e.fov, this.zoom = e.zoom, this.near = e.near, this.far = e.far, this.focus = e.focus, this.aspect = e.aspect, this.view = null === e.view ? null : Object.assign({}, e.view), this.filmGauge = e.filmGauge, this.filmOffset = e.filmOffset, this
        },
    ...
    Oi.prototype = Object.assign(Object.create(Se.prototype), {
        ...
        copy: function(e) {
            return Se.prototype.copy.call(this, e), this.meshPerAttribute = e.meshPerAttribute, this
        },
        toJSON: function() {
    ...
    Hi.prototype = Object.assign(Object.create(Ut.prototype), {
        ...
        raycast: function(e, t) {
            var n = this.matrixWorld,
                i = this.count;
            if (Vi.geometry = this.geometry, Vi.material = this.material, void 0 !== Vi.material)
                for (var r = 0; r < i; r++)
                    this.getMatrixAt(r, zi),
                    Bi.multiplyMatrices(n, zi),
                    Vi.matrixWorld = Bi,
                    Vi.raycast(e, Gi),
                    Gi.length > 0 && (Gi[0].instanceId = r, Gi[0].object = this, t.push(Gi[0]), Gi.length = 0)
        },
    ...
    Xi.prototype = Object.assign(Object.create(me.prototype), {
        ...
        isLight: !0,
        copy: function(e) {
            return me.prototype.copy.call(this, e), this.color.copy(e.color), this.intensity = e.intensity, this
        },
        toJSON: function(e) {
            var t = me.prototype.toJSON.call(this, e);
    ...
    Yi.prototype = Object.assign(Object.create(Ni.prototype), {
        ...
        copy: function(e, t) {
            return Ni.prototype.copy.call(this, e, t), this.left = e.left, this.right = e.right, this.top = e.top, this.bottom = e.bottom, this.near = e.near, this.far = e.far, this.zoom = e.zoom, this.view = null === e.view ? null : Object.assign({}, e.view), this
        },
        setViewOffset: function(e, t, n, i, r, a) {
            null === this.view && (this.view = {
                enabled: !0,
    ...
    Ji.prototype = Object.assign(Object.create(Xi.prototype), {
        ...
        copy: function(e) {
            return Xi.prototype.copy.call(this, e), this.target = e.target.clone(), this.shadow = e.shadow.clone(), this
        }
    }),
    ...
    Qi.prototype.copy = function(e) {
        return Je.prototype.copy.call(this, e), this.color.copy(e.color), this.linewidth = e.linewidth, this.linecap = e.linecap, this.linejoin = e.linejoin, this
    };
    var Ki = new d.a,
        $i = new d.a,
        er = new W,
    ...
    function or(e, t, n, i) {
        ...
        var r,
            ...
            h = new d.a,
            f = new o.a;
        for (l.push(0, 0, 0), c.push(0, 0, 1), u.push(.5, .5), a = 0, r = 3; a <= t; a++, r += 3) {
            var p = n + a / t * i;
            h.x = e * Math.cos(p),
            h.y = e * Math.sin(p),
            l.push(h.x, h.y, h.z),
        ...
        function s(e, t, n, i) {
            ...
            for (r = 0; r < o; r++)
                for (a = 0; a < 2 * (o - r) - 1; a++) {
                    ...
                    a % 2 == 0 ? (l(s[r][d + 1]), l(s[r + 1][d]), l(s[r][d])) : (l(s[r][d + 1]), l(s[r + 1][d + 1]), l(s[r + 1][d]))
                }
        }
        function l(e) {
            r.push(e.x, e.y, e.z)
        ...
        function() {
            for (var e = new d.a, t = 0; t < r.length; t += 3) {
                ...
                var n = h(e) / 2 / Math.PI + .5,
                    i = (s = e, Math.atan2(-s.y, Math.sqrt(s.x * s.x + s.z * s.z)) / Math.PI + .5);
                a.push(n, 1 - i)
            }
            var s;
            (function() {
                for (var e = new d.a, t = new d.a, n = new d.a, i = new d.a, s = new o.a, l = new o.a, c = new o.a, f = 0, p = 0; f < r.length; f += 9, p += 6) {
    ...
    ir.prototype = Object.assign(Object.create(me.prototype), {
        ...
        raycast: function(e, t) {
            var n = e.linePrecision,
                i = this.geometry,
                r = this.matrixWorld;
            if (null === i.boundingSphere && i.computeBoundingSphere(), nr.copy(i.boundingSphere), nr.applyMatrix4(r), nr.radius += n, !1 !== e.ray.intersectsSphere(nr)) {
                er.getInverse(r),
                ...
                if (i.isBufferGeometry) {
                    ...
                    if (null !== f)
                        for (var m = f.array, g = 0, v = m.length - 1; g < v; g += h) {
                            var _ = m[g],
                                x = m[g + 1];
                            if (s.fromArray(p, 3 * _), l.fromArray(p, 3 * x), !(tr.distanceSqToSegment(s, l, u, c) > o))
                        ...
                        for (g = 0, v = p.length / 3 - 1; g < v; g += h) {
                            if (s.fromArray(p, 3 * g), l.fromArray(p, 3 * g + 3), !(tr.distanceSqToSegment(s, l, u, c) > o))
                                u.applyMatrix4(this.matrixWorld),
                                (b = e.ray.origin.distanceTo(u)) < e.near || b > e.far || t.push({
                                    distance: b,
                                    point: c.clone().applyMatrix4(this.matrixWorld),
    ...
    var vr = new function(e) {
        ...
        try {
            ...
            if (t.addEventListener("webglcontextlost", Ee, !1), t.addEventListener("webglcontextrestored", Te, !1), null === (v = n || t.getContext("webgl", xe) || t.getContext("experimental-webgl", xe)))
        ...
        function ye() {
            _ = new Ht(v),
            !1 === (x = new Gt(v, _, e)).isWebGL2 && (_.get("WEBGL_depth_texture"), _.get("OES_texture_float"), _.get("OES_texture_half_float"), _.get("OES_texture_half_float_linear"), _.get("OES_standard_derivatives"), _.get("OES_element_index_uint"), _.get("ANGLE_instanced_arrays")),
        ...
        this.getSize = function(e) {
            return void 0 === e && (console.warn("WebGLRenderer: .getsize() now requires a Vector2 as an argument"), e = new o.a), e.set(te, ne)
        },
        this.setSize = function(e, n, i) {
            Me.isPresenting ? console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.") : (te = e, ne = n, t.width = Math.floor(e * ie), t.height = Math.floor(n * ie), !1 !== i && (t.style.width = e + "px", t.style.height = n + "px"), this.setViewport(0, 0, e, n))
        },
        this.getDrawingBufferSize = function(e) {
            return void 0 === e && (console.warn("WebGLRenderer: .getdrawingBufferSize() now requires a Vector2 as an argument"), e = new o.a), e.set(te * ie, ne * ie).floor()
        },
        ...
        this.getCurrentViewport = function(e) {
            return void 0 === e && (console.warn("WebGLRenderer: .getCurrentViewport() now requires a Vector4 as an argument"), e = new J), e.copy(K)
        },
        ...
        this.renderBufferImmediate = function(e, t) {
            ...
            e.hasPositions && (v.bindBuffer(v.ARRAY_BUFFER, n.position), v.bufferData(v.ARRAY_BUFFER, e.positionArray, v.DYNAMIC_DRAW), y.enableAttribute(i.position), v.vertexAttribPointer(i.position, 3, v.FLOAT, !1, 0, 0)),
            e.hasNormals && (v.bindBuffer(v.ARRAY_BUFFER, n.normal), v.bufferData(v.ARRAY_BUFFER, e.normalArray, v.DYNAMIC_DRAW), y.enableAttribute(i.normal), v.vertexAttribPointer(i.normal, 3, v.FLOAT, !1, 0, 0)),
            e.hasUvs && (v.bindBuffer(v.ARRAY_BUFFER, n.uv), v.bufferData(v.ARRAY_BUFFER, e.uvArray, v.DYNAMIC_DRAW), y.enableAttribute(i.uv), v.vertexAttribPointer(i.uv, 2, v.FLOAT, !1, 0, 0)),
            e.hasColors && (v.bindBuffer(v.ARRAY_BUFFER, n.color), v.bufferData(v.ARRAY_BUFFER, e.colorArray, v.DYNAMIC_DRAW), y.enableAttribute(i.color), v.vertexAttribPointer(i.color, 3, v.FLOAT, !1, 0, 0)),
        ...
        this.renderBufferDirect = function(e, t, n, i, r, a) {
            ...
            y.setMaterial(i, o);
            var l = !1;
            j.geometry === n.id && j.program === s.id && j.wireframe === (!0 === i.wireframe) || (j.geometry = n.id, j.program = s.id, j.wireframe = !0 === i.wireframe, l = !0),
            (i.morphTargets || i.morphNormals) && (N.update(r, n, i, s), l = !0);
            var c = n.index,
            ...
            l && (!function(e, t, n, i) {
                        ...
                        if (void 0 !== c) {
                            ...
                            if (c.isInterleavedBufferAttribute) {
                                var m = c.data,
                                    g = m.stride,
                                    M = c.offset;
                                m && m.isInstancedInterleavedBuffer ? (y.enableAttributeAndDivisor(l, m.meshPerAttribute), void 0 === t.maxInstancedCount && (t.maxInstancedCount = m.meshPerAttribute * m.count)) : y.enableAttribute(l),
                                v.bindBuffer(v.ARRAY_BUFFER, d),
                                v.vertexAttribPointer(l, h, f, u, g * p, M * p)
                            } else
                                c.isInstancedBufferAttribute ? (y.enableAttributeAndDivisor(l, c.meshPerAttribute), void 0 === t.maxInstancedCount && (t.maxInstancedCount = c.meshPerAttribute * c.count)) : y.enableAttribute(l),
                                v.bindBuffer(v.ARRAY_BUFFER, d),
                ...
                y.disableUnusedAttributes()
            }(r, n, i, s), null !== c && v.bindBuffer(v.ELEMENT_ARRAY_BUFFER, h.buffer));
            ...
            if (0 !== A) {
                if (r.isMesh)
                    !0 === i.wireframe ? (y.setLineWidth(i.wireframeLinewidth * me()), f.setMode(v.LINES)) : f.setMode(v.TRIANGLES);
                else if (r.isLine) {
                    var L = i.linewidth;
                    void 0 === L && (L = 1),
                    y.setLineWidth(L * me()),
        ...
        function Ne(e, t, n, i) {
            if (!1 !== e.visible) {
                if (e.layers.test(t.layers))
                    ...
                    else if ((e.isMesh || e.isLine || e.isPoints) && (e.isSkinnedMesh && e.skeleton.frame !== M.render.frame && (e.skeleton.update(), e.skeleton.frame = M.render.frame), !e.frustumCulled || ce.intersectsObject(e))) {
                        i && pe.setFromMatrixPosition(e.matrixWorld).applyMatrix4(fe);
                        r = S.update(e);
                        var a = e.material;
                        if (Array.isArray(a))
        ...
        function De(e, t, n, i) {
            for (var r = 0, a = e.length; r < a; r++) {
                var o = e[r],
                    ...
                    u = o.group;
                if (n.isArrayCamera)
                    if (Q = n, Me.enabled && be.isAvailable())
                        Ce(s, t, n, l, c, u);
                    else
                        for (var h = n.cameras, d = 0, f = h.length; d < f; d++) {
                            var p = h[d];
                            s.layers.test(p.layers) && (y.viewport(K.copy(p.viewport)), g.setupLights(p), Ce(s, t, p, l, c, u))
                        }
                else
                    Q = null,
                    Ce(s, t, n, l, c, u)
        ...
        function Ce(e, t, n, i, r, a) {
            if (e.onBeforeRender(U, t, n, i, r, a), g = R.get(t, Q || n), e.modelViewMatrix.multiplyMatrices(n.matrixWorldInverse, e.matrixWorld), e.normalMatrix.getNormalMatrix(e.modelViewMatrix), e.isImmediateRenderObject) {
                var o = Ue(n, t, r, e);
                y.setMaterial(r),
                j.geometry = null,
                j.program = null,
        ...
        function Ie(e, t, n) {
            ...
            (e.isShaderMaterial || e.isRawShaderMaterial) && !0 !== e.clipping || (i.numClippingPlanes = ue.numPlanes, i.numIntersection = ue.numIntersection, p.clippingPlanes = ue.uniform),
            i.fog = t.fog,
        ...
        function Ue(e, t, n, r) {
            ...
            var u,
                ...
                M = _.getUniforms(),
                E = s.shader.uniforms;
            if (y.useProgram(_.program) && (f = !0, p = !0, m = !0), n.id !== k && (k = n.id, p = !0), f || Y !== e) {
                if (_.numMultiviewViews > 0 ? be.updateCameraProjectionMatricesUniform(e, M) : M.setValue(v, "projectionMatrix", e.projectionMatrix), x.logarithmicDepthBuffer && M.setValue(v, "logDepthBufFC", 2 / (Math.log(e.far + 1) / Math.LN2)), Y !== e && (Y = e, p = !0, m = !0), n.isShaderMaterial || n.isMeshPhongMaterial || n.isMeshToonMaterial || n.isMeshStandardMaterial || n.envMap) {
            ...
            return (p || s.receiveShadow !== r.receiveShadow) && (s.receiveShadow = r.receiveShadow, M.setValue(v, "receiveShadow", r.receiveShadow)), p && (M.setValue(v, "toneMappingExposure", U.toneMappingExposure), M.setValue(v, "toneMappingWhitePoint", U.toneMappingWhitePoint), s.needsLights && (d = m, (u = E).ambientLightColor.needsUpdate = d, u.lightProbe.needsUpdate = d, u.directionalLights.needsUpdate = d, u.pointLights.needsUpdate = d, u.spotLights.needsUpdate = d, u.rectAreaLights.needsUpdate = d, u.hemisphereLights.needsUpdate = d), a && n.fog && function(e, t) {
                e.fogColor.value.copy(t.color),
                t.isFog ? (e.fogNear.value = t.near, e.fogFar.value = t.far) : t.isFogExp2 && (e.fogDensity.value = t.density)
            }(E, a), n.isMeshBasicMaterial ? Fe(E, n) : n.isMeshLambertMaterial ? (Fe(E, n), function(e, t) {
                t.emissiveMap && (e.emissiveMap.value = t.emissiveMap)
            }(E, n)) : n.isMeshToonMaterial ? (Fe(E, n), function(e, t) {
            ...
            }(E, n)) : n.isMeshPhongMaterial ? (Fe(E, n), function(e, t) {
                e.specular.value.copy(t.specular),
                e.shininess.value = Math.max(t.shininess, 1e-4),
                t.emissiveMap && (e.emissiveMap.value = t.emissiveMap);
                t.bumpMap && (e.bumpMap.value = t.bumpMap, e.bumpScale.value = t.bumpScale, 1 === t.side && (e.bumpScale.value *= -1));
                t.normalMap && (e.normalMap.value = t.normalMap, e.normalScale.value.copy(t.normalScale), 1 === t.side && e.normalScale.value.negate());
                t.displacementMap && (e.displacementMap.value = t.displacementMap, e.displacementScale.value = t.displacementScale, e.displacementBias.value = t.displacementBias)
            }(E, n)) : n.isMeshStandardMaterial ? (Fe(E, n, o), n.isMeshPhysicalMaterial ? function(e, t, n) {
                Oe(e, t, n),
            ...
            }(E, n, o) : Oe(E, n, o)) : n.isMeshMatcapMaterial ? (Fe(E, n), function(e, t) {
                t.matcap && (e.matcap.value = t.matcap);
                t.bumpMap && (e.bumpMap.value = t.bumpMap, e.bumpScale.value = t.bumpScale, 1 === t.side && (e.bumpScale.value *= -1));
                t.normalMap && (e.normalMap.value = t.normalMap, e.normalScale.value.copy(t.normalScale), 1 === t.side && e.normalScale.value.negate());
                t.displacementMap && (e.displacementMap.value = t.displacementMap, e.displacementScale.value = t.displacementScale, e.displacementBias.value = t.displacementBias)
            }(E, n)) : n.isMeshDepthMaterial ? (Fe(E, n), function(e, t) {
                t.displacementMap && (e.displacementMap.value = t.displacementMap, e.displacementScale.value = t.displacementScale, e.displacementBias.value = t.displacementBias)
            }(E, n)) : n.isMeshDistanceMaterial ? (Fe(E, n), function(e, t) {
                t.displacementMap && (e.displacementMap.value = t.displacementMap, e.displacementScale.value = t.displacementScale, e.displacementBias.value = t.displacementBias);
                e.referencePosition.value.copy(t.referencePosition),
                e.nearDistance.value = t.nearDistance,
                e.farDistance.value = t.farDistance
            }(E, n)) : n.isMeshNormalMaterial ? (Fe(E, n), function(e, t) {
                t.bumpMap && (e.bumpMap.value = t.bumpMap, e.bumpScale.value = t.bumpScale, 1 === t.side && (e.bumpScale.value *= -1));
                t.normalMap && (e.normalMap.value = t.normalMap, e.normalScale.value.copy(t.normalScale), 1 === t.side && e.normalScale.value.negate());
                t.displacementMap && (e.displacementMap.value = t.displacementMap, e.displacementScale.value = t.displacementScale, e.displacementBias.value = t.displacementBias)
                ...
                t.map ? n = t.map : t.alphaMap && (n = t.alphaMap);
                void 0 !== n && (!0 === n.matrixAutoUpdate && n.updateMatrix(), e.uvTransform.value.copy(n.matrix))
            }(E, n) : n.isShadowMaterial && (E.color.value.copy(n.color), E.opacity.value = n.opacity), void 0 !== E.ltc_1 && (E.ltc_1.value = q.a.LTC_1), void 0 !== E.ltc_2 && (E.ltc_2.value = q.a.LTC_2), Xn.upload(v, s.uniformsList, E, w), n.isShaderMaterial && (n.uniformsNeedUpdate = !1)), n.isShaderMaterial && !0 === n.uniformsNeedUpdate && (Xn.upload(v, s.uniformsList, E, w), n.uniformsNeedUpdate = !1), n.isSpriteMaterial && M.setValue(v, "center", r.center), _.numMultiviewViews > 0 ? be.updateObjectMatricesUniforms(r, e, M) : (M.setValue(v, "modelViewMatrix", r.modelViewMatrix), M.setValue(v, "normalMatrix", r.normalMatrix)), M.setValue(v, "modelMatrix", r.matrixWorld), _
        }
        function Fe(e, t, n) {
            e.opacity.value = t.opacity,
            ...
            var i,
                r,
                a = t.envMap || n;
            a && (e.envMap.value = a, e.flipEnvMap.value = a.isCubeTexture ? -1 : 1, e.reflectivity.value = t.reflectivity, e.refractionRatio.value = t.refractionRatio, e.maxMipLevel.value = b.get(a).__maxMipLevel),
        ...
        this.render = function(e, t) {
            ...
            if (void 0 !== arguments[2] && (console.warn("THREE.WebGLRenderer.render(): the renderTarget argument has been removed. Use .setRenderTarget() instead."), n = arguments[2]), void 0 !== arguments[3] && (console.warn("THREE.WebGLRenderer.render(): the forceClear argument has been removed. Use .clear() instead."), i = arguments[3]), t && t.isCamera) {
                if (!O) {
                    ...
                    null !== V && (w.updateRenderTargetMipmap(V), w.updateMultisampleRenderTarget(V)),
        ...
        this.setRenderTarget = function(e, t, n) {
            ...
            if (e) {
                ...
                e.isWebGLRenderTargetCube ? (i = a[t || 0], r = !0) : i = e.isWebGLMultisampleRenderTarget ? b.get(e).__webglMultisampledFramebuffer : a,
                K.copy(e.viewport),
                $.copy(e.scissor),
                ee = e.scissorTest
            } else
                ...
                ee = le;
            if (H !== i && (v.bindFramebuffer(v.FRAMEBUFFER, i), H = i), y.viewport(K), y.scissor($), y.setScissorTest(ee), r) {
    ...
    const _r = new Worker("/src/worker-physics.js"),
        xr = Math.round((yr = window.innerWidth, (br = 5) + (yr - (Mr = 300)) * (30 - br) / (2e3 - Mr)));
    var yr,
        Mr,
        br;
    let wr,
        ...
        Ar = !0;
    function Lr() {
        Ar && (Ar = !1, wr = Date.now(), _r.postMessage({
            create: Sr,
            N: Pr.length,
            dt: 1 / 60,
            ...
            scales: Er.scales,
            mouse: Jr
        }, [Er.positions.buffer, Er.quaternions.buffer, Er.scales.buffer]), Sr = !1)
    }
